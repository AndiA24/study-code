                                     ...
                                     const DistanceSensor &front_sensor)
{
    ...
    if (front_sensor.get_distance() > critical_distance_m)
    {
        ...
        vehicle.brake(EMERGENCY_BREAK_ACC);
    }
}

void EmergencyBrakeSystem::print_name(){
    std::cout << "[Assistance-Feature]: EmergencyBrakeSystem" << std::endl;
}
...
void LaneKeepingAssist::evaluate(Vehicle &vehicle, const DistanceSensor &front_sensor)
{
...
void LaneKeepingAssist::print_name(){
    std::cout << "[Assistance-Feature]: LaneKeepingAssist" << std::endl;
}
                                     ...
                                     const DistanceSensor &front_sensor)
{
    ...
    if (front_sensor.get_distance() < minimum_distance_m)
    {
        ...
        vehicle.accelerate(Vehicle::STANDARD_ACC);
    }
    ...
    else if (vehicle.get_speed() > target_speed_kmh)
    {
        ...
        vehicle.brake(Vehicle::STANDARD_ACC);
    }
}

void AdaptiveCruiseControl::print_name(){
    std::cout << "[Assistance-Feature]: AdaptiveCruiseControl" << std::endl;
}
